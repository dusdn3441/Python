...
root = Tk()
root.title("NIBUTANI IMAGE FUSION")

# Add/Del
def add_file():
    files = filedialog.askopenfilenames(title="Select Image",
                                        filetypes=(("JPG File", "8.ipg"),("All Files", "*.*")),
                                        initialdir="/Users/gim-yeonjeong/Desktop/Vision/ImageFusion/image")
    for file in files:
...
def browse_dest_path() :
    folder_selected = filedialog.askdirectory(initialdir="/Users/gim-yeonjeong/Desktop/Vision/ImageFusion/image")
    if folder_selected == "" :
        return
...
def start():
    ...
    if len(txt_dest_path.get()) == 0:
        msgbox.showwarning("Warnong", "Select save path")
        return
